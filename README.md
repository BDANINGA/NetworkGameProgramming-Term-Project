...
||||(1) Error:키 값 중복 해결 (3) send_IDPW(), recv_IDPW(), send_login(), recv_login()|(2) Players_Camera() (3) send_ready(), recv_ready() |(1) Error: 키 값에 대한 행동처리문제 해결| 2차토의 (온라인)  |
| 30 |  
|(2) Error: 렌더링 지연 해결 1(네이글 알고리즘)|
---
...
|---|---|---|---|---|---|---|
|| 1 | 2 | 3 | 4 | 5 | 6 |
| |2차토의(오프라인)|(2) 새 게임 규칙 설정 및 구현|(1) Error: 기존 드리블 수정 (2) Error: 렌더링 지연 해결 2(클라의 카메라 문제)|(1) Error: 기존 슛 수정|   |3차토의 (온라인)|
| 7 | 8 | 9 | 10 | 11 | 12 | 13 |
|   |  |    |  최종 테스트 및 결과물 제출  | |   |   |
---

(1) send_chat(), (1) Update_userdata(), PlayerChat() (2) LoadLoginScene()

(1) BroadcastChat() (2) RegisterUser()

(1) ChatUI() 

(2) OnClick_LoginScene()
