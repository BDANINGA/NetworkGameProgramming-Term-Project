...
void InitBuffer()
{
    // ------------------------------------------------------------------------------------
    // vao_player
    glGenVertexArrays(1, &vao_player); //--- VAO 를 지정하고 할당하기
    glBindVertexArray(vao_player);

    glGenBuffers(4, vbo_player); //--- 4개의 VBO를 지정하고 할당하기
    ...
    // -----------------------------------------------------------------------------------------------------------
    // vao_ball
    glGenVertexArrays(1, &vao_ball); //--- VAO 를 지정하고 할당하기
    glBindVertexArray(vao_ball);

    glGenBuffers(4, vbo_ball); //--- 4개의 VBO를 지정하고 할당하기
    ...
    // -----------------------------------------------------------------------------------------------------------
    // vao_goalpost
    glGenVertexArrays(1, &vao_goalpost); //--- VAO 를 지정하고 할당하기
    glBindVertexArray(vao_goalpost);

    glGenBuffers(4, vbo_goalpost); //--- 4개의 VBO를 지정하고 할당하기
